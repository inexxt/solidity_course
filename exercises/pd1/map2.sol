// inspired by https://github.com/ethereum/dapp-bin/blob/master/library/iterable_mapping.sol
...
library IterableMapping
{
  ...
  function iterate_get(itmap storage self, uint keyIndex) returns (bytes32 key, bytes32 value)
  {
...
contract User
{
  ...
  // Insert something
  function insert(bytes32 k, bytes32 v) returns (uint size)
  {
